  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="max-w-4xl mx-auto pt-20">
        <h1 className="text-3xl font-light tracking-widest mb-8 text-center">FILM 4</h1>
        
        <div className="mb-12">
          <video 
            controls 
            className="w-full rounded-lg shadow-lg"
            poster="/Personal_webpage/FILM/Clay Whispers 1-封面.jpg"
          >
            <source src="/Personal_webpage/FILM/film4 renhang.mov" type="video/quicktime" />
