    ...
    <div className="relative min-h-screen w-full" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
      ...
      <section id="contact" className="relative min-h-screen flex items-center justify-center bg-white text-black">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed mb-12">Let&apos;s connect and collaborate</p>
          
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-12">
            {/* Email */}
            <a 
              href="mailto:Zhangchuqi2023@163.com"
              className="flex items-center gap-4 bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 px-8 py-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 group"
            >
              ...
              <div className="text-left">
                <div className="text-sm text-gray-600 uppercase tracking-wide">Email</div>
            ...
            <a 
              ...
              className="flex items-center gap-4 bg-gradient-to-r from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 px-8 py-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 group"
            >
              ...
              <div className="text-left">
                <div className="text-sm text-gray-600 uppercase tracking-wide">LinkedIn</div>
                <div className="text-lg font-semibold text-gray-800">eri-chuqi-zhang</div>
              </div>
            </a>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-300">
            <p className="text-gray-600 text-sm">
              Available for luxury brand collaborations, creative projects, and professional opportunities
            </p>
          </div>
        </div>
      </section>
