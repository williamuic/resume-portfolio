  ...
  return (
    <div className="relative min-h-screen w-full" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
      ...
      <section id="about" className="relative min-h-screen flex items-center justify-center text-white">
        ...
        <div className="max-w-3xl mx-auto text-center z-10 relative bg-black/70 rounded-xl p-8 shadow-2xl backdrop-blur-md">
          <h2 className="text-4xl md:text-5xl font-serif font-bold tracking-widest text-center mb-2" style={{letterSpacing: '0.1em'}}>– Eri Zhang <span className="font-sans text-pink-200 text-2xl align-top">(EH‑ree)</span></h2>
