    ...
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="max-w-4xl mx-auto pt-20">
        ...
        <div className="mb-12">
          ...
          >
            <source src="https://dl.dropboxusercontent.com/scl/fi/dseo9d8u46l8i6v0m7qgk/My-Dear-Art-Clip-2022.mov?rlkey=x19jbvips43smxpgabgpu9jyk&raw=1" type="video/quicktime" />
